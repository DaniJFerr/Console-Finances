...
// Using DOM instances to return the result for the use on html
  ...
  console.log("Greatest increase: " + greatestIncrease.date + " (" + greatestIncrease.profit + ")");
  console.log("Greatest decrease: " + greatestDecrease.date + "(" + greatestDecrease.profit +")");
